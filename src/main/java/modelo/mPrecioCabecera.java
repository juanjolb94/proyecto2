...
public class mPrecioCabecera implements Serializable {
    ...
    private boolean esDefectoVenta = false;

    public boolean isEsDefectoVenta() {
        return esDefectoVenta;
    }

    public void setEsDefectoVenta(boolean esDefectoVenta) {
        this.esDefectoVenta = esDefectoVenta;
    }
}
