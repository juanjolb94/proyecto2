...
import controlador.cIngresoCaja;
...
public class vIngresoCaja extends javax.swing.JInternalFrame implements myInterface {

    private cIngresoCaja controlador;
    ...
    public vIngresoCaja() {
        ...
        try {
            controlador = new cIngresoCaja(this);
    ...
    public void mostrarIngreso(int id, Date fecha, double monto, String concepto,
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Registro de Ingreso de Caja");
